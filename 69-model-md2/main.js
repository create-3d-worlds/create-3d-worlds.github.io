...
const texture = new THREE.TextureLoader().load('../assets/models/ratamahatta/skins/ratamahatta.png')
const loader = new MD2Loader()

loader.load('../assets/models/ratamahatta/ratamahatta.md2', geometry => {

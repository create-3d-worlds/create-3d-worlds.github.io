...
const gui = new GUI.default({ scoreTitle: 'Zombies killed', subtitle: 'Time left', useBlink: true })
...
gui.showGameScreen({ title: 'Survive until morning', subtitle: 'Meet the morning<br>at the cursed graveyard.', callback: () => loop.start() })